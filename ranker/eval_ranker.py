...
from train_ranker import FEATURE_KEYS, RankingDataset, WideDeepRanker, collate_fn, compute_ranking_metrics
...
def main():
    ...
    parser.add_argument('--model-dir', default='ranker/outputs/wide_deep_seed')
    parser.add_argument('--test-file', default='ranker/data/manual_oracle_stage2_deep/test.jsonl')
    parser.add_argument('--output-file', default='ranker/outputs/wide_deep_seed/test_metrics.json')
