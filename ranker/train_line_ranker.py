...
class WideDeepLineRanker(nn.Module):
    def __init__(
        self,
        model_name: str,
        wide_dim: int,
...
def main():
    ...
    parser.add_argument('--train-file', default='ranker/data/manual_line_stage3/train.jsonl')
    parser.add_argument('--valid-file', default='ranker/data/manual_line_stage3/valid.jsonl')
    parser.add_argument('--model-name', default='distilroberta-base')
    parser.add_argument('--output-dir', default='ranker/outputs/line_ranker_seed')
    ...
    train_ds = LineRankingDataset(train_path, feature_keys=selected_feature_keys)
    valid_ds = LineRankingDataset(valid_path, feature_keys=selected_feature_keys)
    ...
    print(f'[OK] Saved best line ranker to {output_dir}')
